  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/admin/add-new-Vehicle/1",
        formData,
        {
          headers: {
    ...
    <VStack spacing={4} alignItems="center" mt={10}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Flex direction="column" gap={4} w="100%" mt="50px">
          ...
          <Flex justify="space-between">
            <FormControl direction="row" display="flex">
              <FormLabel width="220px">Vehicle Type</FormLabel>
              <Select
                name="vehicleType"
          ...
          <Flex justify="space-between">
            ...
            <FormControl direction="row" display="flex">
              <FormLabel width="180px">Transmission Type</FormLabel>
              <Select
                name="transmissionType" // Corrected name attribute
